import { j as e, u as t, i as s, P as r, W as a, l } from "./index-Mgmf_lTV.js";
import { b as n } from "./recharts-bmHCCfxU.js";
...
function i() {
  ...
  return e.jsxs("div", {
    ...
    children: [
      ...
      e.jsx("div", {
        className:
          "fixed inset-0 bg-gradient-to-br from-[#9cf15b]/5 via-transparent to-[#9cf15b]/3 pointer-events-none z-0",
      }),
      e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [
            e.jsxs("div", {
              ...
              children: [
                e.jsx("h1", { className: "sr-only", children: "pyMC Console" }),
                e.jsx(r, { height: 32, className: "mx-auto mb-3" }),
                e.jsxs("p", {
                  className:
                    "font-mono text-text-muted text-sm flex items-center justify-center gap-2",
                  children: [
                    e.jsx(o, { height: 12, fill: "#6B7280" }),
                    e.jsx("span", { children: "Network Management" }),
                  ],
                }),
              ],
            }),
            e.jsxs("div", {
              className:
                "glass-card p-8 rounded-2xl border border-border-subtle bg-bg-surface/80 backdrop-blur-xl shadow-2xl",
              children: [
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsx("div", {
                      className:
                        "inline-flex items-center justify-center w-16 h-16 rounded-full bg-accent-primary/10 mb-4",
                      children: e.jsx("svg", {
                    ...
                    e.jsx("p", {
                      className: "font-mono text-text-muted text-sm mt-1",
                      children: "Sign in to access the console",
                    }),
                  ],
                }),
                e.jsxs("form", {
                  onSubmit: async (e) => {
                    (e.preventDefault(), p(!0), C(null));
                    const t = await l(c, x);
                    (p(!1),
                      t.success
                        ? (window.location.href = "/")
                        : C(t.error || "Login failed"));
                  },
                  className: "space-y-5",
                  children: [
                    e.jsxs("div", {
                      children: [
                        e.jsx("label", {
                          htmlFor: "username",
                          className:
                            "block font-display text-sm font-medium text-text-secondary mb-2",
                          children: "Username",
                        }),
                        e.jsx("input", {
                          id: "username",
                    ...
                    u &&
                      e.jsx("div", {
                        className:
                          "p-3 rounded-lg bg-accent-danger/10 border border-accent-danger/30",
                        children: e.jsxs("p", {
                          className:
                            "font-mono text-sm text-accent-danger flex items-center gap-2",
                          children: [
                            e.jsx("svg", {
            ...
            e.jsx("div", {
              ...
              children: e.jsxs("p", {
                ...
                children: [
                  "A ",
                  e.jsx("span", { style: { color: f }, children: "@RightUp" }),
                  " X ",
                  e.jsx("span", {
                    style: { color: f },
                    children: "@Treehouse⚡",
      ...
      e.jsx("footer", {
        ...
        children: e.jsxs("div", {
          ...
          children: [
            e.jsx("p", {
              className:
                "font-mono text-xs text-text-muted text-center mb-3 uppercase tracking-wider",
              children: "Powered By",
            }),
            e.jsx("div", {
              className:
                "glass-card p-4 rounded-xl border border-border-subtle bg-bg-surface/60 backdrop-blur-xl",
              children: e.jsxs("div", {
                ...
                children: [
                  e.jsx("a", {
                    ...
                    className:
                      "inline-flex items-center gap-2 hover:opacity-80 transition-opacity group",
                    title: "pyMC Repeater",
                    children: e.jsxs("span", {
                      className:
                        "font-display font-bold text-lg tracking-tight",
                      children: [
                        e.jsx("span", { style: { color: f }, children: "py" }),
                        e.jsx("span", {
                  ...
                  e.jsx("a", {
                    ...
                    rel: "noopener noreferrer",
                    className:
                      "inline-flex items-center hover:opacity-80 transition-opacity group",
                    title: "MeshCore",
                    children: e.jsx(o, {
                      height: 14,
                      className: "text-text-primary",
                  ...
                  e.jsxs("a", {
                    ...
                    children: [
                      e.jsx("div", {
                        className:
                          "w-9 h-9 rounded-lg overflow-hidden border border-white/10 group-hover:border-white/20 transition-all",
                        children: e.jsx("img", {
                          src: a,
                          alt: "West Coast Mesh",
                      ...
                      e.jsx("span", {
                        className:
                          "font-display font-bold text-lg tracking-tight text-text-primary",
                        children: "WCM",
                      }),
                    ],
                  }),
