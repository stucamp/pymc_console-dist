import "./recharts-bmHCCfxU.js";
import { g as t } from "./maplibre-gl-CFO9X1Ek.js";
var i,
  e = { exports: {} };
const n = t(
  (i ||
    ...
    (function (t) {
      ...
      ((C.extend = function (t) {
        ...
        return (
          ...
          delete s.includes,
          s.options &&
            ((s.options = o.options ? e(o.options) : {}),
      ...
      var G,
        K = i({}, W, {
          code: "EPSG:3857",
          projection: U,
          transformation: ((G = 0.5 / (Math.PI * U.R)), q(G, 0.5, -G, 0.5)),
        }),
        Y = i({}, K, { code: "EPSG:900913" });
      function X(t) {
        ...
        return (
          "touchstart" === i &&
            (Ft ||
              ...
              document.addEventListener(Nt, Gt, !0),
              document.addEventListener(Dt, Gt, !0),
              (Ft = !0))),
          Ht[i]
            ? ((e = Ht[i].bind(this, e)), t.addEventListener(jt[i], e, !1), e)
            : h
        );
      }
      function Vt(t) {
      ...
      function Kt(t, i) {
        if (i.pointerType !== (i.MSPOINTER_TYPE_MOUSE || "mouse")) {
          for (var e in ((i.touches = []), Wt)) i.touches.push(Wt[e]);
      ...
      if ("onselectstart" in document)
        ((Yt = function () {
          Ci(window, "selectstart", Ni);
        }),
          (Xt = function () {
            Si(window, "selectstart", Ni);
          }));
      else {
        var xi = fi([
          "userSelect",
      ...
      function wi() {
        Ci(window, "dragstart", Ni);
      }
      function bi() {
        Si(window, "dragstart", Ni);
      }
      function Pi(t) {
      ...
      function Ci(t, i, e, n) {
        if (i && "object" == typeof i) for (var o in i) Oi(t, o, i[o], e);
        else
          for (var s = 0, r = (i = c(i)).length; s < r; s++) Oi(t, i[s], e, n);
        return this;
      }
      var Zi = "_leaflet_events";
      function Si(t, i, e, n) {
        if (1 === arguments.length) (Ei(t), delete t[Zi]);
        else if (i && "object" == typeof i) for (var o in i) Ai(t, o, i[o], e);
      ...
      function Oi(t, i, e, n) {
        ...
        var r = function (i) {
          ...
          a = r;
        (!Bt.touchNative && Bt.pointer && 0 === i.indexOf("touch")
          ? (r = Ut(t, i, r))
          : Bt.touch && "dblclick" === i
            ? (r = (function (t, i) {
      ...
      function Ai(t, i, e, n, o) {
        ...
        (!Bt.touchNative && Bt.pointer && 0 === i.indexOf("touch")
          ? (function (t, i, e) {
              jt[i] && t.removeEventListener(jt[i], e, !1);
            })(t, i, r)
          : Bt.touch && "dblclick" === i
            ? (function (t, i) {
            ...
            : "removeEventListener" in t
              ? t.removeEventListener(ki[i] || i, r, !1)
      ...
      function Ii(t) {
        return (Oi(t, "wheel", Bi), this);
      }
      function Ri(t) {
        return (
          Ci(t, "mousedown touchstart dblclick contextmenu", Bi),
      ...
      var Vi = {
        ...
        Gi = S.extend({
          ...
          flyTo: function (t, i, e) {
            ...
            var m = _(0);
            function f(t) {
              return (a * (p(m) * (d((i = m + u * t)) / p(i)) - d(m))) / c;
              var i;
            }
            var g = Date.now(),
              v = (_(1) - m) / u,
          ...
          _initContainer: function (t) {
            ...
            (Ci(i, "scroll", this._onScroll, this), (this._containerId = s(i)));
          },
          ...
          _handleDOMEvent: function (t) {
            ...
            if (
              ...
              var e = t.type;
              ("mousedown" === e && Pi(i), this._fireDOMEvent(t, e));
            }
          },
          _mouseEvents: [
            "click",
          ...
          _getMapPanePos: function () {
            return yi(this._mapPane) || new E(0, 0);
          },
          _moved: function () {
            var t = this._getMapPanePos();
      ...
      var Xi = Ki.extend({
          ...
          addTo: function (t) {
            return (
              Ki.prototype.addTo.call(this, t),
          ...
          _initLayout: function () {
            ...
            (i.setAttribute("aria-haspopup", !0), Ri(i), Ii(i));
          ...
          _expandSafely: function () {
            var t = this._section;
            ((this._preventClick = !0), Ci(t, "click", Ni), this.expand());
            var i = this;
            setTimeout(function () {
              (Si(t, "click", Ni), (i._preventClick = !1));
            });
          },
        }),
        Ji = Ki.extend({
      ...
      var ie = { Events: Z },
        ee = Bt.touch ? "touchstart mousedown" : "mousedown",
        ne = S.extend({
          ...
          enable: function () {
            this._enabled ||
              (Ci(this._dragStartTarget, ee, this._onDown, this),
              (this._enabled = !0));
          },
          disable: function () {
            this._enabled &&
              (ne._dragging === this && this.finishDrag(!0),
              Si(this._dragStartTarget, ee, this._onDown, this),
              (this._enabled = !1),
              (this._moved = !1));
          },
          _onDown: function (t) {
            if (
              ...
              if (t.touches && 1 !== t.touches.length)
                ...
                ((this._startPoint = new E(i.clientX, i.clientY)),
                  (this._startPos = yi(this._element)),
          ...
          finishDrag: function (t) {
            (_i(document.body, "leaflet-dragging"),
              ...
              Si(document, "mousemove touchmove", this._onMove, this),
              Si(document, "mouseup touchend touchcancel", this._onUp, this),
              bi(),
              Xt());
      ...
      function oe(t, i, e) {
        var n,
          ...
          c,
          _ = [1, 4, 2, 8];
        for (o = 0, l = t.length; o < l; o++) t[o]._code = pe(t[o], i);
        for (r = 0; r < 4; r++) {
          for (u = _[r], n = [], o = 0, s = (l = t.length) - 1; o < l; s = o++)
            ((a = t[o]),
              ...
              a._code & u
                ? h._code & u ||
                  (((c = de(h, a, u, i, e))._code = pe(c, i)), n.push(c))
                : (h._code & u &&
                    (((c = de(h, a, u, i, e))._code = pe(c, i)), n.push(c)),
                  n.push(a)));
          t = n;
      ...
      function ce(t, i, e, n, o) {
        var s,
          ...
          h = 0;
        for (r = n + 1; r <= o - 1; r++)
          (a = fe(t[r], t[n], t[o], !0)) > h && ((s = r), (h = a));
        h > e && ((i[s] = 1), ce(t, i, e, n, s), ce(t, i, e, s, o));
      }
      ...
      var Ee = Se.extend({
          ...
          _getIconUrl: function (t) {
            return (
              "string" != typeof Ee.imagePath &&
                (Ee.imagePath = this._detectIconPath()),
              (this.options.imagePath || Ee.imagePath) +
        ...
        Oe = ze.extend({
          ...
          _initIcon: function () {
            ...
            (e !== this._icon &&
              ...
              this.options.autoPanOnFocus &&
                Ci(e, "focus", this._panOnFocus, this));
          ...
          _removeIcon: function () {
            (this.options.riseOnHover &&
              ...
              this.options.autoPanOnFocus &&
                Si(this._icon, "focus", this._panOnFocus, this),
              ri(this._icon),
      ...
      var Ae = ze.extend({
        ...
        Be = Ae.extend({
          ...
          setStyle: function (t) {
            ...
            return (
              Ae.prototype.setStyle.call(this, t),
              this.setRadius(i),
              this
            );
          },
      ...
      var Re = Ae.extend({
        ...
        getCenter: function () {
          ...
          return ye(this._defaultShape(), this._map.options.crs);
        },
        getBounds: function () {
          return this._bounds;
        },
          ...
          if (
            ...
            if (this.options.noClip) this._parts = this._rings;
              ...
              for (var n, o = 0, s = this._rings.length; o < s; o++)
                (n = oe(this._rings[o], t, !0)).length && this._parts.push(n);
        },
        _updatePath: function () {
            ...
            for (
              ...
              ((e = i[s]),
                ...
                e.y > t.y != n.y > t.y &&
                  ...
                  (l = !l));
          return l || Re.prototype._containsPoint.call(this, t, !0);
        },
      });
      var De = Ze.extend({
        initialize: function (t, i) {
      ...
      function je(t, i) {
        ...
        switch (r.type) {
          case "Point":
            return He(l, t, (e = u(a)), i);
          case "MultiPoint":
            for (o = 0, s = a.length; o < s; o++)
              ((e = u(a[o])), h.push(He(l, t, e, i)));
            return new Ze(h);
          case "LineString":
          case "MultiLineString":
            return (
              (n = Fe(a, "LineString" === r.type ? 0 : 1, u)),
              new Re(n, i)
            );
          case "Polygon":
          case "MultiPolygon":
            return ((n = Fe(a, "Polygon" === r.type ? 1 : 2, u)), new Ne(n, i));
      ...
      function Fe(t, i, e) {
        for (var n, o = [], s = 0, r = t.length; s < r; s++)
          ((n = i ? Fe(t[s], i - 1, e) : (e || We)(t[s])), o.push(n));
        return o;
      }
      function Ue(t, i) {
      ...
      function Ve(t, i, e, n) {
        for (var o = [], s = 0, r = t.length; s < r; s++)
          o.push(i ? Ve(t[s], ge(t[s]) ? 0 : i - 1, e, n) : Ue(t[s], n));
        return (!i && e && o.length > 0 && o.push(o[0].slice()), o);
      }
      function qe(t, e) {
        return t.feature ? i({}, t.feature, { geometry: e }) : Ge(e);
      }
      function Ge(t) {
      ...
      var en = tn.extend({
        ...
        onAdd: function (t) {
          (tn.prototype.onAdd.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof Ae || this._source.on("preclick", Bi)));
        },
        onRemove: function (t) {
          (tn.prototype.onRemove.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof Ae || this._source.off("preclick", Bi)));
        },
        getEvents: function () {
        ...
        _updateLayout: function () {
          ...
          (o && n > o ? ((i.height = o + "px"), ci(t, s)) : _i(t, s),
      ...
      (Gi.mergeOptions({ closePopupOnClick: !0 }),
        Gi.include({
          openPopup: function (t, i, e) {
            return (this._initOverlay(en, t, i, e).openOn(this), this);
          },
        ...
        ze.include({
          bindPopup: function (t, i) {
            return (
              (this._popup = this._initOverlay(en, this._popup, t, i)),
          ...
          openPopup: function (t) {
            return (
              this._popup &&
                (this instanceof Ze || (this._popup._source = this),
          ...
          _openPopup: function (t) {
            if (this._popup && this._map) {
              ...
              this._popup._source !== i || i instanceof Ae
        ...
        _setPosition: function (t) {
          ...
          ("top" === a
            ...
            (t = t
              ...
              .add(u)
              .add(c)),
            _i(o, "leaflet-tooltip-right"),
            _i(o, "leaflet-tooltip-left"),
            _i(o, "leaflet-tooltip-top"),
            _i(o, "leaflet-tooltip-bottom"),
            ci(o, "leaflet-tooltip-" + a),
            vi(o, t));
        },
        _updatePosition: function () {
          var t = this._map.latLngToLayerPoint(this._latlng);
      ...
      (Gi.include({
        openTooltip: function (t, i, e) {
          return (this._initOverlay(nn, t, i, e).openOn(this), this);
        },
        ...
        ze.include({
          bindTooltip: function (t, i) {
            return (
              ...
              (this._tooltip = this._initOverlay(nn, this._tooltip, t, i)),
          ...
          openTooltip: function (t) {
            return (
              this._tooltip &&
                (this instanceof Ze || (this._tooltip._source = this),
          ...
          _addFocusListenersOnLayer: function (t) {
            ...
            i &&
              ...
              Ci(i, "blur", this.closeTooltip, this));
          },
        ...
        _setZoomTransform: function (t, i, e) {
          var n = this._map.getZoomScale(e, t.zoom),
            o = t.origin
              ...
              .round();
          Bt.any3d ? gi(t.el, o, n) : vi(t.el, o);
        },
        _resetGrid: function () {
          var t = this._map,
            i = t.options.crs,
          ...
          if (i) {
            ...
            if (
              ...
              for (var l in this._tiles) {
                ...
                (u.z === this._tileZoom && h.contains(new E(u.x, u.y))) ||
      ...
      var rn = sn.extend({
        ...
        initialize: function (t, i) {
          ((this._url = t),
            (i = _(this, i)).detectRetina && Bt.retina && i.maxZoom > 0
        ...
        createTile: function (t, i) {
          ...
          return (
            Ci(e, "load", n(this._tileOnLoad, this, i, e)),
            Ci(e, "error", n(this._tileOnError, this, i, e)),
            (this.options.crossOrigin || "" === this.options.crossOrigin) &&
              (e.crossOrigin =
                !0 === this.options.crossOrigin
                  ? ""
        ...
        _tileOnLoad: function (t, i) {
          Bt.ielt9 ? setTimeout(n(t, this, null, i), 0) : t(null, i);
        },
      ...
      var hn = rn.extend({
        ...
        initialize: function (t, e) {
          ...
          var s = (e = _(this, e)).detectRetina && Bt.retina ? 2 : 1,
            r = this.getTileSize();
        ...
        getTileUrl: function (t) {
          var i = this._tileCoordsToNwSe(t),
            ...
            s = n.max,
            r = (
              this._wmsVersion >= 1.3 && this._crs === Te
                ? [o.y, o.x, s.y, s.x]
                : [o.x, o.y, s.x, s.y]
            ).join(","),
      ...
      var ln = ze.extend({
          ...
          _updateTransform: function (t, i) {
            ...
            Bt.any3d ? gi(this._container, s, e) : vi(this._container, s);
          },
          _reset: function () {
        ...
        un = ln.extend({
          ...
          _initContainer: function () {
            ...
            (Ci(t, "mousemove", this._onMouseMove, this),
              Ci(
                t,
      ...
      function cn(t) {
        return Bt.canvas ? new un(t) : null;
      }
      var _n = (function () {
          try {
            return (
        ...
        dn = {
          ...
          _removePath: function (t) {
            var i = t._container;
            (ri(i), t.removeInteractiveTarget(i), delete this._layers[s(t)]);
          },
          _updateStyle: function (t) {
            var i = t._stroke,
              e = t._fill,
      ...
      function fn(t) {
        return Bt.svg || Bt.vml ? new mn(t) : null;
      }
      (Bt.vml && mn.include(dn),
        Gi.include({
      ...
      (Gi.addInitHook("addHandler", "boxZoom", vn),
      ...
      (Gi.addInitHook("addHandler", "doubleClickZoom", yn),
        Gi.mergeOptions({
          dragging: !0,
          inertia: !0,
      ...
      (Gi.addInitHook("addHandler", "dragging", xn),
            ...
            if (e in this._panKeys) {
              if (!n._panAnim || !n._panAnim._inProgress)
                if (
                  ...
                  n.options.maxBounds &&
                    (i = n._limitOffset(O(i), n.options.maxBounds)),
      ...
      (Gi.addInitHook("addHandler", "keyboard", wn),
        Gi.mergeOptions({
          scrollWheelZoom: !0,
      ...
      Gi.addInitHook("addHandler", "scrollWheelZoom", bn);
      Gi.mergeOptions({
      ...
      var Pn = te.extend({
        ...
        _cancelClickPrevent: function t() {
          (Si(document, "touchend", Ni),
            Si(document, "touchend touchcancel", t));
        },
        _cancel: function () {
          (clearTimeout(this._holdTimeout),
            ...
            Si(document, "touchmove", this._onMove, this));
        },
        _onMove: function (t) {
          var i = t.touches[0];
      ...
      (Gi.addInitHook("addHandler", "tapHold", Pn),
        Gi.mergeOptions({ touchZoom: Bt.touch, bounceAtZoomLimits: !0 }));
      var Ln = te.extend({
        addHooks: function () {
        ...
        _onTouchMove: function (t) {
          if (t.touches && 2 === t.touches.length && this._zooming) {
            ...
            ((this._animRequest = T(a, this, !0)), Ni(t));
          }
        },
        _onTouchEnd: function () {
          this._moved && this._zooming
            ? ((this._zooming = !1),
              ...
              Si(document, "touchend touchcancel", this._onTouchEnd, this),
      ...
      (Gi.addInitHook("addHandler", "touchZoom", Ln),
        (Gi.BoxZoom = vn),
        (Gi.DoubleClickZoom = yn),
        (Gi.Drag = xn),
        (Gi.Keyboard = wn),
        (Gi.ScrollWheelZoom = bn),
        (Gi.TapHold = Pn),
        (Gi.TouchZoom = Ln),
        (t.Bounds = A),
        (t.Browser = Bt),
